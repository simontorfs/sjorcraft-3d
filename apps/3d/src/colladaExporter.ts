  ...
  parse({
    ...
    function processGeometry(bufferGeometry) {
      ...
      if (!info) {
        ...
        libraryGeometries.push(gnode as never);
    ...
    function processTexture(tex) {
      ...
      if (texid == null) {
        ...
        libraryImages.push(imageNode as never);
    ...
    function processMaterial(m) {
      ...
      if (matid == null) {
        ...
        libraryMaterials.push(materialNode as never);
        libraryEffects.push(effectnode as never);
